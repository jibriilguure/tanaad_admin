...
$pdf->Cell(20, 10, "", 'T', 0, 'L');
$pdf->Cell(35, 10, " ", 'T', 0, 'C');
$pdf->Cell(45, 10, "Wadarta", 1, 0, 'L');
$pdf->Cell(30, 10, "$" . $totalDeposit, 1, 0, 'C');
$pdf->Cell(30, 10, "$" . $totalWithDraw, 1, 0, 'C');
$pdf->Cell(30, 10, "$" . $totalCommission, 1, 1, 'C');
$pdf->Ln(1);
// $pdf->Cell(40, 10, "", 'T', 0, 'C');
// $pdf->Cell(40, 10, "", 'T', 0, 'C');
$pdf->Cell(50, 10, "Kharash: %5" , 1, 0, 'C');
$pdf->Cell(50, 10, "$" . $cutAmount, 1, 1, 'C');
